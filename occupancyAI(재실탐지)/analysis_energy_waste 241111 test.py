...
f_name = current_dir / 'occupancyAI(재실탐지)' / 'ean_energy' / 'csv' / 'merged_7f_v0.2.csv'
...
start_date = datetime.datetime(year=2024, month=6, day=1, hour=0, minute=0)
end_date = datetime.datetime(year=2024, month=6, day=30, hour=23, minute=59)
