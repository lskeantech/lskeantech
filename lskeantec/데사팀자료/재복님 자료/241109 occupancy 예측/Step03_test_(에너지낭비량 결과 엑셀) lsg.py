...
#  여기서 os.listdir 함수를 통해 폴더를 찾게 되는데 이때 찾는 디렉토리를 "print("현재 작업 디렉토리:", os.getcwd())"로 찾을 수 있음
#  찾아봤을떄 내 경우 lskeantech로 나옴. 그래서 경로를 맞게 바꿔줬는데, 그게 27열의 "os.chdir(os.path.dirname(os.path.abspath(__file__)))"임
