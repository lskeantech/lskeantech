...
for target_date in date_range:
  ...
  hmm.fit(data_20[['plug','weekday','Co2','plug_Co2']])
  # plug_today = target_data.loc[target_start:target_end, ['plug_weekday','timedata_weekday','Co2','plug_mean_5']]
  plug_today = target_data.loc[target_start:target_end, ['plug','weekday','Co2','plug_Co2']]
  ...
  avg_0 = plug_today.loc[mask==0, 'plug_Co2'].mean()
  avg_1 = plug_today.loc[mask==1, 'plug_Co2'].mean()
