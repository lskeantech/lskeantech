...
# plug 변화량 추가
df['plug_change'] = df['plug'].diff()

# Co2 변화량 추가
df['Co2_change'] = df['Co2'].diff()
...
end_date = datetime.datetime(year=2024, month=11, day=19, hour=23, minute=59)
...
for target_date in date_range:
  ...
  hmm.fit(data_20[['plug','weekday','Co2']])
  ...
  plug_today = target_data.loc[target_start:target_end, ['plug','weekday','Co2']]
